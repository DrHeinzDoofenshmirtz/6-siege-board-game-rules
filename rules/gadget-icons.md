...
| Strength | ▲1 | Gadgets or partitions with this strength rating can be destroyed by gadgets and Operators with the ▲1, ■2, or ⬟3 destruction rating. |
...
| Destruction | ▲1 | This gadget or Operator destroys partitions and gadgets with the ▲1 strength rating. |
| Destruction | ■2 | This gadget or Operator destroys partitions and gadgets with the ▲1 or ■2 strength rating. |
| Destruction | ⬟3 | This gadget destroys partitions and gadgets with the ▲1, ■2, or ⬟3 strength rating. |
...
The strength ratings ▲1 and ■2, and the Bulletproof 🔩 attribute, apply
...
See also: destroy, gadgets-general, gadget-keywords
