...
2 to 4 players, 14+, ~60 minutes. Designer: Carlos Gomez Quintana. Published
by Mythic Games. Based on Ubisoft's game *Tom Clancy's Rainbow Six: Siege*.

--- Page 2 ---

**_INTRODUCTION_**

*Tom Clancy's Rainbow Six: Siege* is a tactical shooter video game in which
two squads face off for training missions carried out under realistic
conditions in authentic destructible environments. The game focuses on the
players' ability to cooperate and devise successful team strategies. Players
play as Operators, hand-picked from special forces and counter-terrorism
units; together they form Team Rainbow. Each Operator has their own special
equipment and attributes.

*6: Siege – The Board Game* is an asymmetric board game for 2 – 4 players in
two opposing squads. Games are played with a time limit and are set in
various environments inspired by maps from the video game. Each squad
consists of 5 Operators (either attackers or defenders). The standard
gameplay mode is for two players at an intermediate difficulty level and it
uses the core rules in this rulebook. There are also 'Special Ops' modules
for a more challenging experience, and a 'Multiplayer' mode supporting up to
four players.

This game requires the *6: Siege – The Board Game* app, which can be
downloaded for free on Google Play Store and Apple Store.

If you are unable to use the app, or prefer not to, see the 'No App' variant
on page 29.
...
| Operator status | 9 |
| Setup sequence | 11 |
| Gameplay sequence | 14 |
| Activating an Operator | 15 |
| Operator actions | 16 |
| Move | 16 |
| Run | 18 |
| Shoot | 18 |
| Protection | 19 |
| Overwatch | 20 |
| Use a Tactical Gadget | 22 |
| Use a Special Gadget effect (**ACTION**) | 22 |
| Destroy | 23 |
| Operator reactions | 24 |
| Challenges | 24 |
| Gadgets | 25 |
| Other important rules | 29 |
| 'No App' mode | 29 |
| Special Ops modules | 30 |
| Multiplayer mode | 31 |
| Hints and tips | 33 |
| Index | 34 |
| Credits | 35 |
...
- 1 Mission Guide
- 3 Bomb miniatures
- 2 Hostage tokens & 1 miniature
- 15 Control tokens
- 2 Line of Sight (LoS) Rulers (different sizes)
- 7 Hit dice (3 🟡 yellow, 2 🟠 orange, 2 🔴 red)
- 1 Double-sided game board (2 environments)
- 2 Fortified Wall tokens (1 single, 1 double)
- 1 Round Tracker marker
- 11 Barricaded door standees (8 single, 3 double)
- 13 Barricaded window standees (10 single, 3 double)
- 16 Breach standees (8 single, 8 double)
- 15 Obstacle standees
- 10 Located markers
- 10 Stunned markers
- 30 Wound tokens
- 8 Smoke, Gas, and Fire overlays (4-space and 2-space)
- 1 Drone marker
- 10 Bonus tokens (for the 'No App' variant)
- 2 Player aids
- 1 Operator list
...
- 2 Reroll tokens (1 orange, 1 blue)
- 50 Charge cubes (for gadgets)
...
- 10 Activation tokens (5 orange, 5 blue)
- 7 Tactical Gadget tokens (3 Barbed Wire, 2 Claymores, 2 Fortified Entryways)
- 5 Special Gadget tokens (2 CED-1 Shock Wires, 3 Armor Plates)
- 8 Tactical Gadget miniatures (5 Cameras, 3 Bulletproof Cameras)
- 5 Special Gadget miniatures (2 Signal Disruptors, 3 Kóna Stations)
- 4 Armor Panel standees
- 2 Deployable Shield standees
- 10 Overwatch markers (5 orange, 5 blue)
- 28 Operator profiles
- 28 Revealed Operator miniatures — Attacker miniatures / Defender miniatures
- 24 Base rings
- 24 Hidden Operator tokens
- 6 masks (described in the *Mission Guide*)
- 10 Leaning standees (5 orange, 5 blue)
- 24 Named Entryway Overwatch tokens
- 1 Activatable Gadget token for the Operator Montagne ('Activated' side and 'Ready' side)
- 1 Sheet of self-adhesive labels
- 1 Setup aid
...
- or leave the miniature in its current space space and return the Leaning
...
**_Use a Special Gadget **ACTION** effect_**
...
(for an **attacker**) or **ACTION** icon (for a **defender**).
...
This gadget must be used from the an upper floor area. It can target any
space in a 🔲 room.
...
The strength ratings ⚠️1, 🟧2, and Bulletproof 🔩 apply only to the Destroy
action (see Destroy action, p. 23).
...
**_Tactical gadgets for defenders_**
...
**_Tactical gadgets for attackers_**
...
|---|---|---|
| Beginner | 20 minutes / 10 minutes | 12 0seconds |
...
| ⚠️ | 17 |
| Action | — |
| ACTION — Destroy | 15, 16 |
| ACTION — Run | 18 |
| ACTION — Move | 18 |
| ACTION — Overwatch | 20 |
| ACTION — Shoot | 18 |
| ACTION — Use Tactical Gadget | 22 |
| ACTION — Use a Special Gadget effect | 22 |
| Activation (Operator) | 14, 15 |
| Adjacency | 7 |
| Application (App) | 2, 12 |
| Area capacity | 7, 8, 9 |
| Barricade | 8, 19 |
| Breach | 8, 23 |
| Camera | 28 |
...
| Charge cube | 12, 22 |
| Deployment | 13 |
| Destruction rating ⚠️🟧🔴 | 23, 26 |
| Door | 7, 23 |
| Entryway space | 8, 18 |
| Eliminated (Operator) | 10 |
| Exchange of fire | 21 |
| Fortified Entryway | 28 |
| Fortified wall | 8, 19 |
| Free action | 20 |
| Free space | 7 |
| Gadgets | 11, 25 |
| Gameplay sequence | 14 |
| Heavy wall | 8, 19 |
| Hidden (Operator) | 10, 15 |
| Hit dice | 11 |
| Holed wall | 8, 19 |
| In play (Operator) | 10 |
| KEYWORD — Overlays | 27 |
| KEYWORD — Line of sight | 27 |
| KEYWORD — Throwable | 27 |
| KEYWORD — Deployable | 27 |
| KEYWORD — Wave | 27 |
| KEYWORD — Setup | 7, 27 |
| KEYWORD — Vertical | 7, 27 |
| Leaning position | 17, 19, 26 |
| Light wall | 8, 19 |
| Line of cover | 19 |
| Line of sight | 6, 9, 25 |
| Limited components | 29 |
| Located 🎯 | 9 |
| Main floor | 7 |
| Missions | 5, 11 |
| MODULE — Forward Planning | 5, 30 |
| MODULE — Advanced Tactics | 30 |
| MODULE — Competitive Gaming | 31 |
| Multiplayer mode | 31 |
| 'No App' variant | 29 |
| Obstacle | 8, 19 |
| Occupied space | 7 |
| Operator profile | 11 |
| Overwatching (Operator) | 10, 20 |
| Partitions | 8, 23 |
| Perimeter space | 7, 13 |
| Protection | 19 |
| Range | 11, 18 |
| Reaction | 22, 24 |
| Recruit | 31 |
| Reroll token | 29, 32 |
| Reveal (hidden Operator) | 10, 21 |
| Riposte | 22 |
| Room | 7 |
| Room 🔲 | 7, 27 |
| Shield 🛡️ | — |
...
| Stamina | 11 |
| Straightening up | 18 |
| Strength rating ⚠️🟧🔴 | 23, 26 |
| Structural element | 8 |
| Stunned 💀 | 9 |
| Tactical gadgets | 28 |
| Tactical inventory | 12, 22 |
| Timer | 12, 15, 18, 24 |
| Upper floor area | 8, 18, 20, 21 |
| Window | 7, 23 |
| Wound 💀 | 11 |
